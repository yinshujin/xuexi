...
answer 是正确选项的序号（从 0 开始）；多个序号表示多选（题干里写上“多选”）。每个 quiz 2–4 题，题目多就分成两个 quiz
（例如“课堂小题”和“挑战题”）。判断题用两个选项 ["对","错"]。
...
- 讲解课 8–12 分钟（约 8–11 页、40–70 句 say）；技巧课 3–5 分钟（约 4–5 页、15–30 句 say）。
- 讲解课要有一页“学法口诀”和一页“快速推理”（如求最大、最小的数，□ 里最大或最小能填几），技巧课把方法编成一句口诀。
- 小题题型要多样：判断、单选、多选、推理都要有；讲解课 6–8 道，技巧课 3–5 道。
`;

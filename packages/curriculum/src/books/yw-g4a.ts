...
export const ywG4a: Book = {
  ...
  sourceNote: [
    ...
    '【仍未核对】各课正文及新版是否有删改：古诗、文言文（精卫填海、王戎不取道旁李）按通行原文；现代文课文只用人物、情节梗概和生字词，不整段引用。',
  ].join(''),
  units: [
    // ------------------------------------------------------------------ 一
    unit(B, 1, '自然之美', [
    ...
    unit(B, 3, '连续观察', [
      ...
      },
      {
        ...
        keyPoints: [
          '重点：蟋蟀不肯随遇而安，住宅要选排水好、有温和阳光的地方；它用前足扒土、用钳子搬土块、用强有力的后足踏地，工作很辛苦',
    ...
    unit(B, 4, '中外神话', [
      ...
      },
      {
        ...
        keyPoints: [
          '重点：人类没有火—普罗米修斯从太阳神那里盗取火种—宙斯大怒，命火神把他锁在高加索山上，派鹫鹰每天啄食他的肝脏—大力神赫拉克勒斯救了他',
      ...
      },
      {
        ...
        keyPoints: [
          '重点：天塌地裂、大火洪水，人们受苦—女娲决心补天—找齐五彩石，炼成熔浆把天补好',
    ...
    unit(B, 8, '家国情怀', [
      ...
      },
      {
        ...
        keyPoints: [
          '重点：伯父说“中华不振”—周恩来在租界目睹中国人受外国人欺负却无处说理—校长问为什么读书，他回答“为中华之崛起而读书”',

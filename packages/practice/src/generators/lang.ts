...
const HINTS: Record<string, string> = {
  ...
  // ---- 写作（写话）
  把句子补完整: '先找一找：谁？在哪里？干什么？缺了哪一样，就补哪一样。',
  找完整的句子: '一句一句问三问：谁？在哪里？干什么？三样都找得到才完整。',
  句子三件套: '一句完整的话：谁 + 在哪里 + 干什么。把句子分成这三块再找。',
  写完问三问: '指着句子问：谁？在哪里？干什么？找不到的那一块就是缺的。',
  选时间词: '一天的事按早上、中午、放学后、晚上的顺序写。',
  改一改: '找出缺的、多的、乱的地方，改完再读一遍，通不通顺？',
  选标点: '读一读这句话的语气：说一件事用句号，问问题用问号，高兴、惊讶、着急用叹号，中间停一停用逗号。',
  认标点: '句号 。逗号 ，问号 ？叹号 ！引号 “ ” 冒号 ：',
  引号: '说的原话放进引号里，引号前面用冒号，句末的标点写在后引号里面。',
  标点改错: '一个一个标点看：句末的语气对不对？引号成对了吗？冒号放对了吗？',
  提示语: '“笑着说”“着急地问”告诉我们谁在说、怎么说，要和心情对得上。',
  写具体: '比一比：哪一句写出了颜色、样子、声音或动作的样子，让人好像看到了、听到了？',
  声音词: '小声模仿一下这个声音，哪个词最像？',
  的和地: '“的”后面是东西（红红的苹果），“地”后面是动作（慢慢地走）。',
  打比方: '像什么？要找样子真的差不多的东西来比。',
  看听闻: '用眼睛看颜色形状，用耳朵听声音，用鼻子闻气味，用手摸一摸。',
  句式: '“有的……有的……还有的……”要写出几种不一样的样子。',
  看图四问: '看图先问四个问题：什么时候？在哪里？有谁？在干什么？',
  看图写话: '按“什么时候、在哪里、有谁、在干什么”看图，哪句话把图上的事说对了、说完整了？',
  想象说话: '看看图上人物的表情和动作，想想这时候他会说什么、想什么。',
  排顺序: '先找第一句，再看“先、接着、然后、最后”和时间词，一句接一句连起来读。',
  选开头: '好开头要点题：一下子告诉别人要写什么、写谁。',
  选结尾: '好结尾要接得上前面的内容，可以写结果，也可以写心情和感受。',
  找不通顺的句子: '一句一句小声读，读着别扭、前后对不上、词语搭配不当的就是不通顺的。',
  写样子: '写样子：颜色、形状、大小，摸起来怎么样，按顺序写，可以打个比方。',
  写特点: '写特点：它会做什么？怎么玩？什么味道？要写出和别的东西不一样的地方。',
  为什么喜欢: '用“因为……”说出真实的理由，最好写一件具体的小事。',
  顺序词: '先、接着、然后、最后，按事情的先后用。',
  心情: '想一想，遇到这件事，心里会是什么感觉？心情要和事情对得上。',
  写一件事: '写一件事：什么时候、谁、做了什么（经过）、结果怎么样、心情如何。',
  步骤卡: '动笔前把事情分成几步，每步写几个字，排好顺序再写。',
  留言条格式: '留言条四部分：称呼顶格加冒号，正文空两格，署名和日期写在右下方。',
  留言条内容: '留言条正文要写清：去哪里、干什么、什么时候回来。',
  日记格式: '日记第一行写日期、星期、天气；正文空两格，挑一件事写清楚。',
  续编: '接着开头往下想：角色和地点不变，事情顺着发展，结尾要合情合理。',
  角色特点: '想一想这个角色平时是什么样子的：蜗牛爬得慢，兔子跑得快，小鸟会飞。',
  故事地图: '故事地图三格：开头、经过、结尾，每格只写几个字。',
  // ---- 写作（四年级 xz4.skills）
  审题: '先圈出题目里的关键词（写谁、写什么、怎样写），再看哪一个正好合乎要求。',
  描写方法: '写样子是外貌，写做什么是动作，写说的话是语言，写脸上的表情是神态，写心里想的是心理。',
  句子排序: '先找总起的句子或最先发生的事，再按时间、地点或事情发展的顺序一句句接下去。',
  提纲: '按事情发展或介绍的顺序排：开头—经过（或几个方面）—结尾，最重要的部分写得最详细。',
  修改病句: '一句一句读，找找有没有搭配不当、意思重复、缺了部分或前后矛盾。',
  修改符号: '删除号删去多余的字，增补号补上漏写的字，调换号调换位置，恢复号把删错的恢复。',
  说明方法: '列数字用准确的数，打比方把事物比成熟悉的东西，作比较拿两样东西比一比。',
  书信格式: '称呼顶格加冒号，问候语空两格；“此致”空两格，“敬礼”另起一行顶格；署名、日期在右下方。',
  过渡句: '过渡句像一座桥：前半句说上面的内容，后半句引出下面要说的。',
  首尾呼应: '看看结尾有没有回到开头说过的话或事物，前后接得上。',
  观察方法: '想想用了哪种感官：眼睛看、耳朵听、鼻子闻、手摸；再看有没有和前一天比一比。',
  想象: '好的想象要新奇，又要合理：人物的本领和性格不能变，事情前后要说得通。',
  资料: '先把资料分类（位置、历史、特点、价值），只挑有用的，再用自己的话写。',
  写心情: '心情藏在心里话、身体的感觉、动作神态和周围的景物里，别只写“我很紧张”。',
  写作知识: '回想课上学的写作方法，一项一项对照，看哪个说法是对的。',
};

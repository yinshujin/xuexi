...
- 讲解课 8–11 页、技巧课 4–5 页。每个 quiz 放 2–4 道题，题目多就分成两个 quiz（“课堂小题”“挑战题”）。
- 题型要多样：判断（选项 ["对","错"]）、单选、多选、推理（求最大 / 最小、□ 里能填几）；讲解课 6–8 道，技巧课 3–5 道。
- 每节课都要有好记的学法口诀；讲解课再加一页“快速推理”，教孩子怎样很快想出最大、最小这类答案。

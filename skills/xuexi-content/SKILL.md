...
- 讲解课 6–9 页、技巧课 2–4 页；每节课都有一页“学法口诀”（2–4 句，顺口好记，和方法一致）；讲解课再加一页“快速推理”，教孩子怎样很快想出最大、最小这类答案。
- 课堂小题按题型分组放在最后：讲解课判断题 3 道、选择题 3–4 道（可含多选）、填空与解决问题 3 道；技巧课判断题 2 道、选择与填空 2–3 道。
- 白板内容会保留到下一页：每页用完白板要关闭，下次写新内容前先擦；白板打开时会盖住幻灯片，聚光灯和激光笔要在关闭白板后再用。
